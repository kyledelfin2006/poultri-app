...
export default function WelcomeScreen() {
  ...
  return <SafeAreaView style={styles.safe}>
    ...
    <View style={styles.loginCard}>
      ...
      <View style={styles.accountField}><Text style={styles.fieldLabel}>Farm</Text><Text style={styles.fieldValue}>{ready ? data.farmName : 'Demo Layer Farm'}</Text></View>
...
const styles = StyleSheet.create({
  safe: { flex: 1, backgroundColor: colors.white, justifyContent: 'space-between', padding: 24 },
  ...
  accountField: { backgroundColor: colors.white, borderColor: colors.line, borderWidth: 1, borderRadius: 12, padding: 12, gap: 4, marginTop: 5 }, fieldLabel: { color: colors.muted, fontSize: 11 }, fieldValue: { color: colors.ink, fontSize: 14, fontWeight: '700' },
